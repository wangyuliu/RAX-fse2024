...
\section{RAX}
The following is an introduction to the process of RAX construction.
...
This is because developers need a holistic understanding of the project during the porting process, and CC can represent the overall complexity of the project, potentially reflecting porting barriers, as the picture shows:
...
Correlation comparison between Arch\_code and other factors acquired by Commit analyzer,as the picture shows:
