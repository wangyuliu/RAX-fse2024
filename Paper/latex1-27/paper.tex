...
To solve the problem of unbalanced datasets and small sample datasets, we used ensemble learning methods \cite{6509481}, SMOTE \cite{4271036}, and random oversampling methods for data preprocessing\cite{5128907} addressing. By comparing multiple indicators, we select the Random Forest\textcolor{red}{, which had the highest accuracy of 0.857} as the classifier, as shown in Table \ref{tab:evaluation}.
